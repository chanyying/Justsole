...
// ----------------------------  CONFIG DB  ----------------------------- //
$_config['db']['1']['dbhost'] = 'mysql.sql104.cdncenter.net';
$_config['db']['1']['dbuser'] = 'sq_caihanyong';
$_config['db']['1']['dbpw'] = 'caihanyong';
$_config['db']['1']['dbcharset'] = 'utf8';
$_config['db']['1']['pconnect'] = '0';
$_config['db']['1']['dbname'] = 'sq_caihanyong';
$_config['db']['1']['tablepre'] = 'cy_';
$_config['db']['common']['slave_except_table'] = '';
$_config['db']['slave'] = '';

// --------------------------  CONFIG MEMORY  --------------------------- //
$_config['memory']['prefix'] = 'OOUMSh_';
...
// --------------------------  CONFIG COOKIE  --------------------------- //
$_config['cookie']['cookiepre'] = 'Kie1_';
$_config['cookie']['cookiedomain'] = '.justsole.cn';
$_config['cookie']['cookiepath'] = '/';

// -------------------------  CONFIG SECURITY  -------------------------- //
$_config['security']['authkey'] = 'a57086o7jpLKuy53';
