...
$lang = array (
  ...
  'article_delete_sure' => '确认要删除此课程吗？',
  'article_description' => '摘要',
  'article_edit' => '编辑课程',
  'article_forbidcomment_description' => '禁止评论',
  'article_getauthorall' => '获取楼主所有帖子',
  'article_id' => '课程 ID',
  'article_pushplus' => '课程连载',
  'article_related' => '添加相关课程',
  'article_send_continue' => '继续发布新课程',
  'article_send_succeed' => '发布课程成功',
  ...
  'article_validate_has_added' => '该课程已经添加过了',
  'article_validate_noexist' => '没有找到指定的课程',
  'article_html_existed' => 'HTML静态文件名重名',
  'article_validate_title' => '标题长度(1~80字符)不符合要求',
  'grab' => '获取',
  'ignore' => '忽略',
  'moderate_article' => '审核课程',
  'page_title' => '分页标题',
  'passed' => '通过',
  'portalcp_article_message1' => '个新帖将添加到课程连载。',
  ...
  'article_manage' => '课程管理',
  'article_new' => '新课程',
  'article_not_choose' => '请选择要操作的课程',
  'article_operation' => '操作',
  'article_subject' => '课程标题',
