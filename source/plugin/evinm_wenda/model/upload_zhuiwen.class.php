...
if($num != 0) {
	...
	*/
	...
	$ask_data = array(
		'qid'=>intval($_GET['qid']),		
		'iszw'=>intval($_GET['zw_ac']),		
		'qid'=>intval($_GET['qid']),		
		'zw_aid'=>intval($_GET['zw_hid']),		
		'zw_uid'=>intval($_GET['zw_uid']),		
	...
	DB::insert('evinm_wenda_answer',$ask_data);
	showmessage('操作成功！', 'plugin.php?id=evinm_wenda:list_article&qid='.$ask_data['qid'], array(), array('showdialog' => true, 'locationtime' => true));
?>