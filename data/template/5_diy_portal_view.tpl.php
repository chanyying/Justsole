...
0
|| checktplrefresh('./template/default/portal/view.htm', './template/default/portal/portal_comment.htm', 1408078466, 'diy', './data/template/5_diy_portal_view.tpl.php', './template/default', 'portal/view')
|| checktplrefresh('./template/default/portal/view.htm', './template/default/common/seccheck.htm', 1408078466, 'diy', './data/template/5_diy_portal_view.tpl.php', './template/default', 'portal/view')
...
<a  id="related_article" href="portal.php?mod=portalcp&amp;ac=related&amp;aid=<?php echo $article['aid'];?>&amp;catid=<?php echo $article['catid'];?>&amp;update=1" onclick="showWindow(this.id, this.href, 'get', 0);return false;">添加相关课程</a><span class="pipe">|</span>
<?php if($article['status']>0 && ($_G['group']['allowmanagearticle'] || $categoryperm[$value['catid']]['allowmanage'])) { ?>
