<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('search_so');
0
|| checktplrefresh('./source/plugin/evinm_wenda/template/search_so.htm', './template/mobanbus_boohee/common/header.htm', 1408981617, 'evinm_wenda', './data/template/5_evinm_wenda_search_so.tpl.php', './source/plugin/evinm_wenda/template', 'search_so')
|| checktplrefresh('./source/plugin/evinm_wenda/template/search_so.htm', './source/plugin/evinm_wenda/template/head.htm', 1408981617, 'evinm_wenda', './data/template/5_evinm_wenda_search_so.tpl.php', './source/plugin/evinm_wenda/template', 'search_so')
|| checktplrefresh('./source/plugin/evinm_wenda/template/search_so.htm', './template/default/common/footer.htm', 1408981617, 'evinm_wenda', './data/template/5_evinm_wenda_search_so.tpl.php', './source/plugin/evinm_wenda/template', 'search_so')
|| checktplrefresh('./source/plugin/evinm_wenda/template/search_so.htm', './template/mobanbus_boohee/common/header_common.htm', 1408981617, 'evinm_wenda', './data/template/5_evinm_wenda_search_so.tpl.php', './source/plugin/evinm_wenda/template', 'search_so')
|| checktplrefresh('./source/plugin/evinm_wenda/template/search_so.htm', './template/mobanbus_boohee/common/pubsearchform.htm', 1408981617, 'evinm_wenda', './data/template/5_evinm_wenda_search_so.tpl.php', './source/plugin/evinm_wenda/template', 'search_so')
;?>
...
<?php } ?>
        ...
        </div><div id="warper" class="wp cl mtm mbm" style="background:#FEFEFE;border: 1px solid #9DCF9F;">
           <div class="search clearfix" style="float:none;padding-left:0;margin-top:100px; margin-bottom:100px;height:150px;">
                <div class="logo cl" style="background:url(<?php echo $config['slogo'];?>) no-repeat;float:none;margin:35px auto; text-align:center;" >
                    <a href="<?php if($rewrite == '1') { ?>wenda/ <?php } else { ?> plugin.php?id=evinm_wenda:index  <?php } ?>">
问答中心
                    </a>
                </div>
<div class="cl" style="float:none;margin:auto; text-align:center;width:610px;">
<form class="sh-form" action="<?php if($rewrite == '1') { ?>wenda/search.html<?php } else { ?> plugin.php?id=evinm_wenda:search<?php } ?>" method="post">
<div class="ipt-sh">
<input maxlength="100" id="search_kw" type="text" name="s" autocomplete="off" value = "<?php echo $sk;?>"
x-webkit-speech="">
</div>
<div class="bt-sh">
<button id="btn_search_ask" type="submit">
