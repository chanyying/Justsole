...
0
|| checktplrefresh('./template/default/forum/forumdisplay_fastpost.htm', './template/default/common/seditor.htm', 1408078311, '5', './data/template/5_5_forum_forumdisplay_fastpost.tpl.php', './template/mobanbus_boohee', 'forum/forumdisplay_fastpost')
|| checktplrefresh('./template/default/forum/forumdisplay_fastpost.htm', './template/default/forum/seccheck_post.htm', 1408078311, '5', './data/template/5_5_forum_forumdisplay_fastpost.tpl.php', './template/mobanbus_boohee', 'forum/forumdisplay_fastpost')
|| checktplrefresh('./template/default/forum/forumdisplay_fastpost.htm', './template/default/common/upload.htm', 1408078311, '5', './data/template/5_5_forum_forumdisplay_fastpost.tpl.php', './template/mobanbus_boohee', 'forum/forumdisplay_fastpost')
|| checktplrefresh('./template/default/forum/forumdisplay_fastpost.htm', './template/default/common/seccheck.htm', 1408078311, '5', './data/template/5_5_forum_forumdisplay_fastpost.tpl.php', './template/mobanbus_boohee', 'forum/forumdisplay_fastpost')
;?>
...
<div id="f_pst" class="bm" style="background-color:#F3F9FB;">
<div class="bm_c">
...
EOF;
?><?php unset($secshow);?><?php if(empty($secreturn)) { ?><?php echo $seccheckhtml;?><?php } ?></div><?php } ?>
</div>
