...
0
|| checktplrefresh('./template/default/search/portal.htm', './template/default/search/header.htm', 1408538889, '5', './data/template/5_5_search_portal.tpl.php', './template/mobanbus_boohee', 'search/portal')
|| checktplrefresh('./template/default/search/portal.htm', './template/default/search/pubsearch.htm', 1408538889, '5', './data/template/5_5_search_portal.tpl.php', './template/mobanbus_boohee', 'search/portal')
|| checktplrefresh('./template/default/search/portal.htm', './template/default/search/portal_list.htm', 1408538889, '5', './data/template/5_5_search_portal.tpl.php', './template/mobanbus_boohee', 'search/portal')
|| checktplrefresh('./template/default/search/portal.htm', './template/default/search/footer.htm', 1408538889, '5', './data/template/5_5_search_portal.tpl.php', './template/mobanbus_boohee', 'search/portal')
|| checktplrefresh('./template/default/search/portal.htm', './template/mobanbus_boohee/common/header_common.htm', 1408538889, '5', './data/template/5_5_search_portal.tpl.php', './template/mobanbus_boohee', 'search/portal')
;?>
...
<div  class="cl" style="border-bottom:1px #C6C6C6 solid; background-color:#000000; height:30px; color:#EEE;">
 <?php $mnid = getcurrentnav();?><div class="y" style="margin-top:6px;">
<?php if($_G['uid']) { ?>
<a href="home.php?mod=space&amp;do=home"><?php echo $_G['member']['username'];?></a>
...
<tr>
<td><h1><a href="search.php" title="<?php echo $_G['setting']['bbname'];?>"><img src="<?php echo IMGDIR;?>/logo_sc_s.gif" alt="<?php echo $_G['setting']['bbname'];?>" /></a></h1></td>
<td>
...
<div class="hm mtw ptw pbw"><h1 class="mtw ptw"><a href="./" title="<?php echo $_G['setting']['bbname'];?>"><img src="<?php echo IMGDIR;?>/logo_sc.gif" alt="<?php echo $_G['setting']['bbname'];?>" /></a></a></h1></div>
...
<div id="ft" class="w cl" style="bottom:0; text-align:center;width:auto; height:15px; line-height:15px; z-index:1;position:fixed; ">
