...
0
|| checktplrefresh('./template/default/portal/portalcp_article.htm', './template/default/home/editor_image_menu.htm', 1409123951, '5', './data/template/5_5_portal_portalcp_article.tpl.php', './template/mobanbus_boohee', 'portal/portalcp_article')
|| checktplrefresh('./template/default/portal/portalcp_article.htm', './template/default/common/seccheck.htm', 1409123951, '5', './data/template/5_5_portal_portalcp_article.tpl.php', './template/mobanbus_boohee', 'portal/portalcp_article')
|| checktplrefresh('./template/default/portal/portalcp_article.htm', './template/default/common/upload.htm', 1409123951, '5', './data/template/5_5_portal_portalcp_article.tpl.php', './template/mobanbus_boohee', 'portal/portalcp_article')
...
<h3 class="flb">
<em id="return_<?php echo $_GET['handlekey'];?>">审核课程</em>
<?php if($_G['inajax']) { ?><span><a href="javascript:;" onclick="hideWindow('<?php echo $_GET['handlekey'];?>');" class="flbc" title="关闭">关闭</a></span><?php } ?>
</h3>
...
<div class="c">
<b><?php echo $pushcount;?></b> 个新帖将添加到课程连载。<a href="<?php echo $article_url;?>" target="_blank" class="xi2">(查看课程)</a>
...
<a href="<?php echo $article_add_url;?>&op=edit&aid=<?php echo $aid;?>">编辑课程</a>
<span class="pipe">|</span>
<a href="<?php echo $article_add_url;?>">继续发布新课程</a>
<span class="pipe">|</span>
<a href="portal.php?mod=view&amp;aid=<?php echo $aid;?>" target="_blank">查看课程</a>
<?php if($htmlstatus) { ?>
<span class="pipe">|</span>
...
<?php } if(!empty($aid)) { ?>
<a href="portal.php?mod=portalcp&amp;ac=article&amp;aid=<?php echo $article['aid'];?>">编辑课程</a>
<?php } else { ?>
<a href="portal.php?mod=portalcp&amp;ac=article&amp;catid=<?php echo $catid;?>">发布课程</a>
<?php } ?>
</div>
</div>
...
<div class="mn">
<div class="bm bw0">
<h1 class="mbm bbs mt"><?php if(!empty($aid)) { ?>编辑课程<?php } else { ?>发布课程<?php } ?></h1>
...
<div class="exfm">
<h2>添加相关课程 <a id="related_article" href="portal.php?mod=portalcp&amp;ac=related&amp;aid=<?php echo $aid;?>" class="xi2" style="text-decoration: underline;" onclick="showWindow(this.id, this.href+'&catid='+$('catid').value, 'get', 0);return false;">选择</a></h2>
<ul id="raid_div" class="xl">
<?php if($article['related']) { if(is_array($article['related'])) foreach($article['related'] as $raid => $rtitle) { ?><li id="raid_li_<?php echo $raid;?>"><input type="hidden" name="raids[]" value="<?php echo $raid;?>" size="5"><a href="portal.php?mod=view&amp;aid=<?php echo $raid;?>" target="_blank"><?php echo $rtitle;?></a> (课程 ID: <?php echo $raid;?>) <a href="javascript:;" onclick="raid_delete(<?php echo $raid;?>);" class="xg1">删除</a></li>
<?php } } ?>
</ul>
</div>
