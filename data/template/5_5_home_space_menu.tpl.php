...
0
|| checktplrefresh('./template/default/home/space_menu.htm', './template/default/home/follow_user_header.htm', 1408078485, '5', './data/template/5_5_home_space_menu.tpl.php', './template/mobanbus_boohee', 'home/space_menu')
;?>
<div style="z-index:0;"><img src="<?php echo IMGDIR;?>/sign.gif" /></div>
<?php if($space['uid']) { ?>
<div id="uhd">
...
<?php } ?>
<div class="h cl">
<div class="gerenavt"><a href="home.php?mod=space&amp;uid=<?php echo $space['uid'];?>"><?php echo avatar($space[uid],middle);?></a></div>
<h2 class="mt" style="margin-left:100px; margin-top:-80px;">
...
<a href="<?php echo $_G['siteurl'];?>?<?php echo $uid;?>" class="xg1"><?php echo $_G['siteurl'];?>?<?php echo $uid;?></a>已有<font color="#CD6F5A"><?php echo $space['views'];?></font>人来过
