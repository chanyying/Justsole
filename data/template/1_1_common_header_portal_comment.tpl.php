...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1409351073, '1', './data/template/1_1_common_header_portal_comment.tpl.php', './template/default', 'common/header_portal_comment')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1409351073, '1', './data/template/1_1_common_header_portal_comment.tpl.php', './template/default', 'common/header_portal_comment')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1409351073, '1', './data/template/1_1_common_header_portal_comment.tpl.php', './template/default', 'common/header_portal_comment')
;?>
...
<?php } ?>
    <script src="<?php echo $_G['setting']['jspath'];?>topname.js?<?php echo VERHASH;?>" type="text/javascript"></script>
...
<?php } ?></li>
<li><a id="switchblind" href="javascript:;" onClick="toggleBlind(this)" title="开启辅助访问" class="switchblind">开启辅助访问</a>
...
<li style="margin-top:15px;"><a href="javascript:;" id="qmenu" onMouseOver="delayShow(this, function () {showMenu({'ctrlid':'qmenu','pos':'34!','ctrlclass':'a','duration':2});showForummenu(<?php echo $_G['fid'];?>);})"><img src="<?php echo IMGDIR;?>/hide.png"/></a></li>
                 </ul>
</div>
</div>
</div>
