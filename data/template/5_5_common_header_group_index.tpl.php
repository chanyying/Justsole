...
0
|| checktplrefresh('./template/mobanbus_boohee/common/header.htm', './template/mobanbus_boohee/common/header_common.htm', 1408078458, '5', './data/template/5_5_common_header_group_index.tpl.php', './template/mobanbus_boohee', 'common/header_group_index')
|| checktplrefresh('./template/mobanbus_boohee/common/header.htm', './template/mobanbus_boohee/common/pubsearchform.htm', 1408078458, '5', './data/template/5_5_common_header_group_index.tpl.php', './template/mobanbus_boohee', 'common/header_group_index')
;?>
