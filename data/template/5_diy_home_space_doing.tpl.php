...
0
|| checktplrefresh('./template/default/home/space_doing.htm', './template/default/home/space_header.htm', 1408090595, 'diy', './data/template/5_diy_home_space_doing.tpl.php', './template/mobanbus_boohee', 'home/space_doing')
|| checktplrefresh('./template/default/home/space_doing.htm', './template/default/common/userabout.htm', 1408090595, 'diy', './data/template/5_diy_home_space_doing.tpl.php', './template/mobanbus_boohee', 'home/space_doing')
|| checktplrefresh('./template/default/home/space_doing.htm', './template/default/home/space_userabout.htm', 1408090595, 'diy', './data/template/5_diy_home_space_doing.tpl.php', './template/mobanbus_boohee', 'home/space_doing')
|| checktplrefresh('./template/default/home/space_doing.htm', './template/mobanbus_boohee/common/header_common.htm', 1408090595, 'diy', './data/template/5_diy_home_space_doing.tpl.php', './template/mobanbus_boohee', 'home/space_doing')
|| checktplrefresh('./template/default/home/space_doing.htm', './template/default/home/space_diy.htm', 1408090595, 'diy', './data/template/5_diy_home_space_doing.tpl.php', './template/mobanbus_boohee', 'home/space_doing')
|| checktplrefresh('./template/default/home/space_doing.htm', './template/default/home/space_header_personalnv.htm', 1408090595, 'diy', './data/template/5_diy_home_space_doing.tpl.php', './template/mobanbus_boohee', 'home/space_doing')
;?>
...
<div id="toptb" class="cl" style="background:#2967A6; height:45px;  border-bottom: 1px solid #2967A6; " >
<div  style="background:#2967A6; height:45px; line-height:45px; width:960px; text-align:center;margin-right:auto;margin-left:auto; color:#EEE;">
<?php if($_G['uid']) { ?>
<div class="y" style="margin-top:3px;">
<a href="home.php?mod=space&amp;do=home" id="navs" onMouseOver="showMenu(this.id);"><img src="uc_server/avatar.php?uid=<?php echo $_G['uid'];?>&amp;size=small" style="width:22px; height:22px; border-radius:2px; margin-top:10px;"/></a>
...
<?php if($space['self'] && $do == 'index') { ?><a id="diy-tg" href="javascript:openDiy();" title="装扮空间" style="margin-top:5px;">DIY</a><?php } ?>
</div>
...
<div class="bm bw0">
<div class="bm_c">
<?php } if($space['self'] && helper_access::check_module('doing')) { include template('home/space_doing_form'); } } else { include template('common/header'); ?><style id="diy_style" type="text/css"></style>
    <style>
...
<div class="appl"><?php if(!empty($_G['setting']['pluginhooks']['global_userabout_top'][$_G['basescript'].'::'.CURMODULE])) echo $_G['setting']['pluginhooks']['global_userabout_top'][$_G['basescript'].'::'.CURMODULE];?><?php getuserapp(1);?><ul>
     <a href="home.php?mod=space&amp;uid=<?php echo $space['uid'];?>" target="_blank" title="<?php echo $_G['member']['username'];?>"><?php echo avatar($_G[uid],middle);?></a><br /><br /><?php if(is_array($_G['setting']['spacenavs'])) foreach($_G['setting']['spacenavs'] as $nav) { if($nav['available'] && (!$nav['level'] || ($nav['level'] == 1 && $_G['uid']) || ($nav['level'] == 2 && $_G['adminid'] > 0) || ($nav['level'] == 3 && $_G['adminid'] == 1))) { if(in_array($nav['code'], array('userpanelarea1', 'userpanelarea2'))) { if(!empty($_G['my_panelapp']) && $_G['setting']['my_app_status']) { if($nav['code']=='userpanelarea1' && !empty($_G['my_panelapp']['1'])) { if(is_array($_G['my_panelapp']['1'])) foreach($_G['my_panelapp']['1'] as $appid => $app) { ?><li>
...
<div class="mn pbm">
<table><tr><td><font size="+3"><?php echo $_G['member']['username'];?></font></td>
      <td><ul id="navigation"> 
<li onmouseover="displaySubMenu(this)" onmouseout="hideSubMenu(this)"> 
<a href="home.php">个人中心</a></li></ul></td>
<td><ul id="navigation"> 
<li onmouseover="displaySubMenu(this)" onmouseout="hideSubMenu(this)"> 
<a href="forum.php?mod=collection">书包</a></li></ul></td>
<td><ul id="navigation"> 
<li onmouseover="displaySubMenu(this)" onmouseout="hideSubMenu(this)"> 
...
<td><ul id="navigation"> 
<li onmouseover="displaySubMenu(this)" onmouseout="hideSubMenu(this)"> 
<a href="home.php?mod=space&amp;do=wall">留言板</a></li></ul></td>
<td><ul id="navigation"> 
<li onmouseover="displaySubMenu(this)" onmouseout="hideSubMenu(this)"> 
<a href="#">更多...</a> 
<ul> 
<li><a href="home.php?mod=space&amp;do=favorite&amp;view=me">收藏</a></li>
<li><a href="home.php?mod=space&amp;do=activity&amp;view=me">活动</a></li>
<li><a href="home.php?mod=space&amp;do=poll&amp;view=me">投票</a></li>
<li><a href="home.php?mod=space&amp;do=reward&amp;view=me">悬赏</a></li>
<li><a href="home.php?mod=space&amp;do=trade&amp;view=me">商品</a></li>
</ul> 
</li> 
</ul></td></tr></table>
...
<?php } if($dv['uid']==$_G['uid']) { ?><a href="home.php?mod=spacecp&amp;ac=doing&amp;op=delete&amp;doid=<?php echo $doid;?>&amp;id=<?php echo $dv['id'];?>&amp;handlekey=doinghk_<?php echo $doid;?>_<?php echo $dv['id'];?>" id="<?php echo $key;?>_doing_delete_<?php echo $doid;?>_<?php echo $dv['id'];?>" onclick="showWindow(this.id, this.href, 'get', 0);">删除</a><?php } ?>
</dd>
</dl>
<?php } if($pricount) { ?>
