...
0
|| checktplrefresh('./template/mobanbus_boohee/common/header.htm', './template/mobanbus_boohee/common/header_common.htm', 1408084712, '5', './data/template/5_5_common_header.tpl.php', './template/mobanbus_boohee', 'common/header')
|| checktplrefresh('./template/mobanbus_boohee/common/header.htm', './template/mobanbus_boohee/common/pubsearchform.htm', 1408084712, '5', './data/template/5_5_common_header.tpl.php', './template/mobanbus_boohee', 'common/header')
;?>
