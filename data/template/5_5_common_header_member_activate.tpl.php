...
0
|| checktplrefresh('./template/mobanbus_boohee/common/header.htm', './template/mobanbus_boohee/common/header_common.htm', 1408741301, '5', './data/template/5_5_common_header_member_activate.tpl.php', './template/mobanbus_boohee', 'common/header_member_activate')
|| checktplrefresh('./template/mobanbus_boohee/common/header.htm', './template/mobanbus_boohee/common/pubsearchform.htm', 1408741301, '5', './data/template/5_5_common_header_member_activate.tpl.php', './template/mobanbus_boohee', 'common/header_member_activate')
;?>
