...
0
|| checktplrefresh('./template/default/forum/collection_mycollection.htm', './template/default/forum/collection_nav.htm', 1408422726, '5', './data/template/5_5_forum_collection_mycollection.tpl.php', './template/mobanbus_boohee', 'forum/collection_mycollection')
|| checktplrefresh('./template/default/forum/collection_mycollection.htm', './template/default/forum/collection_list.htm', 1408422726, '5', './data/template/5_5_forum_collection_mycollection.tpl.php', './template/mobanbus_boohee', 'forum/collection_mycollection')
...
<li class="y" style="background-color:#FFB900; width:80px; height:40px; text-align:center;"><a href="forum.php?mod=collection&amp;action=edit">创建淘专辑</a></li>
<?php } ?>
