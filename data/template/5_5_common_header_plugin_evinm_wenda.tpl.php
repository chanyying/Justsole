...
0
|| checktplrefresh('./template/mobanbus_boohee/common/header.htm', './template/mobanbus_boohee/common/header_common.htm', 1408082808, '5', './data/template/5_5_common_header_plugin_evinm_wenda.tpl.php', './template/mobanbus_boohee', 'common/header_plugin_evinm_wenda')
|| checktplrefresh('./template/mobanbus_boohee/common/header.htm', './template/mobanbus_boohee/common/pubsearchform.htm', 1408082808, '5', './data/template/5_5_common_header_plugin_evinm_wenda.tpl.php', './template/mobanbus_boohee', 'common/header_plugin_evinm_wenda')
;?>
