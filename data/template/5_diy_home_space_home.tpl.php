...
0
|| checktplrefresh('./template/default/home/space_home.htm', './template/default/home/space_header.htm', 1408211167, 'diy', './data/template/5_diy_home_space_home.tpl.php', './template/mobanbus_boohee', 'home/space_home')
|| checktplrefresh('./template/default/home/space_home.htm', './template/default/home/space_userabout.htm', 1408211167, 'diy', './data/template/5_diy_home_space_home.tpl.php', './template/mobanbus_boohee', 'home/space_home')
|| checktplrefresh('./template/default/home/space_home.htm', './template/mobanbus_boohee/common/header_common.htm', 1408211167, 'diy', './data/template/5_diy_home_space_home.tpl.php', './template/mobanbus_boohee', 'home/space_home')
|| checktplrefresh('./template/default/home/space_home.htm', './template/default/home/space_diy.htm', 1408211167, 'diy', './data/template/5_diy_home_space_home.tpl.php', './template/mobanbus_boohee', 'home/space_home')
|| checktplrefresh('./template/default/home/space_home.htm', './template/default/home/space_header_personalnv.htm', 1408211167, 'diy', './data/template/5_diy_home_space_home.tpl.php', './template/mobanbus_boohee', 'home/space_home')
;?>
<?php if(empty($diymode)) { include template('common/header'); if($_G['setting']['homestyle']) { ?><?php echo adshow("text/wp a_t");?><?php } ?>
...
<a href="home.php?mod=space&amp;uid=<?php echo $space['uid'];?>"<?php g_color($space[groupid]);?>><?php echo $space['username'];?></a><br /><br /></h3>
                                    访问：<strong><?php echo $space['views'];?></strong><br />
                                    帖子：<strong><?php echo $space['posts'];?></strong><br />
</td>
</tr>
</table>
</div>
                 <?php if($space['profileprogress'] != 100) { ?>
<div class="bm">
<div class="bm_c">
...
<?php } ?>
<div class="mn ptm pbm" style="width:700px;">
...
<tr>
<td>
<h3 class="xs2"><?php g_icon($space[groupid]);?></h3><?php include template('home/space_status'); ?></td>
</tr>
</table>
