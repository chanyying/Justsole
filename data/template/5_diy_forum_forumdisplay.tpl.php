...
0
|| checktplrefresh('./template/default/forum/forumdisplay.htm', './template/default/forum/recommend.htm', 1408078119, 'diy', './data/template/5_diy_forum_forumdisplay.tpl.php', './template/mobanbus_boohee', 'forum/forumdisplay')
|| checktplrefresh('./template/default/forum/forumdisplay.htm', './template/default/common/seccheck.htm', 1408078119, 'diy', './data/template/5_diy_forum_forumdisplay.tpl.php', './template/mobanbus_boohee', 'forum/forumdisplay')
|| checktplrefresh('./template/default/forum/forumdisplay.htm', './template/default/forum/forumdisplay_list.htm', 1408078119, 'diy', './data/template/5_diy_forum_forumdisplay.tpl.php', './template/mobanbus_boohee', 'forum/forumdisplay')
|| checktplrefresh('./template/default/forum/forumdisplay.htm', './template/default/forum/forumdisplay_sort.htm', 1408078119, 'diy', './data/template/5_diy_forum_forumdisplay.tpl.php', './template/mobanbus_boohee', 'forum/forumdisplay')
|| checktplrefresh('./template/default/forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1408078119, 'diy', './data/template/5_diy_forum_forumdisplay.tpl.php', './template/mobanbus_boohee', 'forum/forumdisplay')
|| checktplrefresh('./template/default/forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1408078119, 'diy', './data/template/5_diy_forum_forumdisplay.tpl.php', './template/mobanbus_boohee', 'forum/forumdisplay')
...
<div id="fancyNavdiv">
<ul id="fancyNav">
<li id="home"><a href="index.php" class="homeIcon"><img src="<?php echo IMGDIR;?>/home.png" /></a></li>
<li><a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>"><?php echo $_G['forum']['name'];?></a></li>
<li > <?php if(!$_GET['archiveid']) { ?>
                    <a href="javascript:;" id="newspecial" onmouseover="$('newspecial').id = 'newspecialtmp';this.id = 'newspecial';showMenu({'ctrlid':this.id})"<?php if(!$_G['forum']['allowspecialonly'] && empty($_G['forum']['picstyle']) && !$_G['forum']['threadsorts']['required']) { ?> onclick="showWindow('newthread', 'forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>')"<?php } else { ?> onclick="location.href='forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>';return false;"<?php } ?> title="发新帖">发布信息</a>
                    <?php } ?></li>
<li><span <?php if($_G['setting']['visitedforums']) { ?>id="visitedforums" onmouseover="$('visitedforums').id = 'visitedforumstmp';this.id = 'visitedforums';showMenu({'ctrlid':this.id,'pos':'34'})"<?php } ?> ><a href="forum.php">浏览记录</a></span></li>
<li ><a href="home.php?mod=spacecp&amp;ac=favorite&amp;type=forum&amp;id=<?php echo $_G['fid'];?>&amp;handlekey=favoriteforum" id="a_favorite" onclick="showWindow(this.id, this.href, 'get', 0);">收藏本版 <span class="xi1" id="number_favorite" <?php if(!$_G['forum']['favtimes']) { ?> style="display:none;"<?php } ?>>(<span id="number_favorite_num"><?php echo $_G['forum']['favtimes'];?></span>)</span></a></li>
<li><?php if(rssforumperm($_G['forum']) && $_G['setting']['rssstatus'] && !$_GET['archiveid'] && !$subforumonly) { ?><a href="forum.php?mod=rss&amp;fid=<?php echo $_G['fid'];?>&amp;auth=<?php echo $rssauth;?>" target="_blank" title="RSS">订阅</a><?php } ?></li>
</ul>
        </div>
