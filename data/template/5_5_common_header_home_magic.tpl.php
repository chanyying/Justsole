...
0
|| checktplrefresh('./template/mobanbus_boohee/common/header.htm', './template/mobanbus_boohee/common/header_common.htm', 1408086466, '5', './data/template/5_5_common_header_home_magic.tpl.php', './template/mobanbus_boohee', 'common/header_home_magic')
|| checktplrefresh('./template/mobanbus_boohee/common/header.htm', './template/mobanbus_boohee/common/pubsearchform.htm', 1408086466, '5', './data/template/5_5_common_header_home_magic.tpl.php', './template/mobanbus_boohee', 'common/header_home_magic')
;?>
