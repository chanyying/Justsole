...
0
|| checktplrefresh('./template/mobanbus_boohee/common/header.htm', './template/mobanbus_boohee/common/header_common.htm', 1408657571, '5', './data/template/5_5_common_header_misc_faq.tpl.php', './template/mobanbus_boohee', 'common/header_misc_faq')
|| checktplrefresh('./template/mobanbus_boohee/common/header.htm', './template/mobanbus_boohee/common/pubsearchform.htm', 1408657571, '5', './data/template/5_5_common_header_misc_faq.tpl.php', './template/mobanbus_boohee', 'common/header_misc_faq')
;?>
