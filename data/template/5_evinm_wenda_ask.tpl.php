<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('ask');
0
|| checktplrefresh('./source/plugin/evinm_wenda/template/ask.htm', './template/mobanbus_boohee/common/header.htm', 1408142334, 'evinm_wenda', './data/template/5_evinm_wenda_ask.tpl.php', './source/plugin/evinm_wenda/template', 'ask')
|| checktplrefresh('./source/plugin/evinm_wenda/template/ask.htm', './source/plugin/evinm_wenda/template/head.htm', 1408142334, 'evinm_wenda', './data/template/5_evinm_wenda_ask.tpl.php', './source/plugin/evinm_wenda/template', 'ask')
|| checktplrefresh('./source/plugin/evinm_wenda/template/ask.htm', './template/default/common/seditor.htm', 1408142334, 'evinm_wenda', './data/template/5_evinm_wenda_ask.tpl.php', './source/plugin/evinm_wenda/template', 'ask')
|| checktplrefresh('./source/plugin/evinm_wenda/template/ask.htm', './template/default/common/footer.htm', 1408142334, 'evinm_wenda', './data/template/5_evinm_wenda_ask.tpl.php', './source/plugin/evinm_wenda/template', 'ask')
|| checktplrefresh('./source/plugin/evinm_wenda/template/ask.htm', './template/mobanbus_boohee/common/header_common.htm', 1408142334, 'evinm_wenda', './data/template/5_evinm_wenda_ask.tpl.php', './source/plugin/evinm_wenda/template', 'ask')
|| checktplrefresh('./source/plugin/evinm_wenda/template/ask.htm', './template/mobanbus_boohee/common/pubsearchform.htm', 1408142334, 'evinm_wenda', './data/template/5_evinm_wenda_ask.tpl.php', './source/plugin/evinm_wenda/template', 'ask')
;?>
...
<?php } ?>
        ...
        </div>        <div id="bd" class="mtm mbm cl" style="background:#FEFEFE;border: 1px solid #9DCF9F;padding-bottom: 40px;">			
<div style="margin:auto; width:700px; " class="article cl">
<div class="mod-ask-form cl">
<div class="hd"><h3>我想问一下</h3></div>
</div>
<div class="bd">				
<form class="mod-ask-form" method="post" id="hdform" action="plugin.php?id=evinm_wenda:ask" autocomplete="off" enctype="multipart/form-data">
<input type="hidden" name="formhash" value="<?php echo FORMHASH;?>" />
<input type="hidden" name="handlekey" value="<?php echo $_G['gp_handlekey'];?>" />
<div class="pbt cl mtm">
<div class="z">
<span>									
<?php if($ac == 'edit' && !empty($qid)) { ?>	
分类: <?php echo $edit_ask['sup_name'];?> > <?php echo $edit_ask['f_name'];?>    
<?php } else { ?>	
<?php if($list_f) { ?>	
<select name="class">
<option value="">&nbsp;&nbsp;&gt; 请选择分类</option>
<option value="">&nbsp;</option><?php if(is_array($list_f)) foreach($list_f as $mood) { if($mood['type']=='group') { ?>						
<optgroup label="-- <?php echo $mood['name'];?>"><?php if(is_array($list_f_t)) foreach($list_f_t as $moodt) { if($moodt['type']=='sup' && $moodt['fid'] == $mood['id']) { ?>
&nbsp;&nbsp;&nbsp;&nbsp;<option value="<?php echo $moodt['id'];?>"><?php echo $moodt['name'];?></option>
<?php } } ?>
<option></option>
</optgroup>
<?php } } ?>
...
<span>
<input type="text" name="subject" id="subject" class="px" value="<?php if($ac == 'edit' && !empty($qid)) { ?> <?php echo $edit_ask['subject'];?> <?php } ?>" onblur="if($('tags')){relatekw('-1','-1',function(){extraCheck(4)});doane();}"
...
<div class="area">
<textarea rows="10" cols="80" name="message" id="fastpostmessage" tabindex="12" class="pt" ><?php if($ac == 'edit' && !empty($qid)) { ?> <?php echo $edit_ask['message'];?> <?php } ?></textarea>
</div>
</div>
</div>
<div class="cl" style="position: relative;">
<div class="add-img">
<div style="top: -110px; left: 713px; line-height: 18px; width: 160px; "
class="tooltips">
<div class="content">
上传图片以详细说明；<br>
悬赏越高，<br>
...
<div class="add-pay y">
<label for="coin">
我的<?php echo $config['points_name'];?> ：<?php echo $config['points_user'];?> ， 
悬赏
</label>
<select name="coin" id="coin">
<?php if($mjf == 1) { ?>	
<?php if($ac == 'edit' && !empty($qid) && $edit_ask['coin'] <= 0) { ?> 
<option value="0">
0
</option>
<?php } if($ac == '') { ?> 
...
<?php } } if($ac == 'edit' && !empty($qid) && $edit_ask['coin'] <= 5) { ?> 
<option value="5">
5
</option>
<?php } if($ac == '') { ?> 
...
<?php } if($ac == 'edit' && !empty($qid) && $edit_ask['coin'] <= 10) { ?> 
<option value="10">
10
</option>
<?php } if($ac == '') { ?> 
...
<?php } if($ac == 'edit' && !empty($qid) && $edit_ask['coin'] <= 15) { ?> 
<option value="15">
15
</option>
<?php } if($ac == '') { ?> 
...
<?php } if($ac == 'edit' && !empty($qid) && $edit_ask['coin'] <= 20) { ?> 
<option value="20">
20
</option>
<?php } if($ac == '') { ?> 
...
<?php } if($ac == 'edit' && !empty($qid) && $edit_ask['coin'] <= 30) { ?> 
<option value="30">
30
</option>
<?php } if($ac == '') { ?> 
...
<?php } if($ac == 'edit' && !empty($qid) && $edit_ask['coin'] <= 50) { ?> 
<option value="50">
50
</option>
<?php } if($ac == '') { ?> 
...
<?php } if($ac == 'edit' && !empty($qid) && $edit_ask['coin'] <= 80) { ?> 
<option value="80">
80
</option>
<?php } if($ac == '') { ?> 
...
<?php } if($ac == 'edit' && !empty($qid) && $edit_ask['coin'] <= 100) { ?> 
<option value="100">
100
</option>
<?php } if($ac == '') { ?> 
...
<?php } if($ac == 'edit' && !empty($qid) && $edit_ask['coin'] <= 200) { ?> 
<option value="200">
200
</option>
<?php } if($ac == '') { ?> 
...
<?php } if($ac == 'edit' && !empty($qid) && $edit_ask['coin'] <= 500) { ?> 
<option value="500">
500
</option>
<?php } if($ac == '') { ?> 
...
<?php } if($ac == 'edit' && !empty($qid) && $edit_ask['coin'] <= 800) { ?> 
<option value="800">
800
</option>
<?php } if($ac == '') { ?> 
...
<?php } if($ac == 'edit' && !empty($qid) && $edit_ask['coin'] <= 1000) { ?> 
<option value="1000">
1000
</option>
<?php } if($ac == '') { ?> 
...
<div class="y cl" style="width:220px;">
<?php if($_G['uid']) { ?>
<div class="z" style="margin-top:30px;">
<label>
<input name="ishidden" type="checkbox" value="1">&nbsp;&nbsp;匿名提问
</label>
</div>
<?php } ?>
<div class="q-btn">						
<button name="hdsubmit" class="pn pnc" value="yes">提交问题</button></div>

<?php if($ac == 'edit' && !empty($qid)) { ?> 
<input name="amod" type="hidden" value="<?php echo $ac;?>">
