...
0
|| checktplrefresh('./template/mobanbus_boohee/common/header.htm', './template/mobanbus_boohee/common/header_common.htm', 1408132049, '5', './data/template/5_5_common_header_forum_guide.tpl.php', './template/mobanbus_boohee', 'common/header_forum_guide')
|| checktplrefresh('./template/mobanbus_boohee/common/header.htm', './template/mobanbus_boohee/common/pubsearchform.htm', 1408132049, '5', './data/template/5_5_common_header_forum_guide.tpl.php', './template/mobanbus_boohee', 'common/header_forum_guide')
;?>
