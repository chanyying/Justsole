...
<div class="bm fl cl">
<div class="bm_h">
<div class="xzfl"><a href="/">&nbsp;&nbsp;&nbsp;<?php echo $curtype['name'];?>-共有 <?php echo $curtype['groupnum'];?> 个<?php echo $_G['setting']['navs']['3']['navname'];?>&nbsp;&nbsp;&nbsp;</a></div>
                <span class="y">
                <a href="forum.php?mod=group&amp;action=create&amp;fupid=<?php echo $fup;?>&amp;groupid=<?php echo $sgid;?>" id="create_group_btn">创建<?php echo $_G['setting']['navs']['3']['navname'];?></a>
...
<?php if($list) { if($curtype['forumcolumns'] > 1) { ?>
<div class="bm_c">
