...
0
|| checktplrefresh('./template/mobanbus_boohee/common/header.htm', './template/mobanbus_boohee/common/header_common.htm', 1408080420, '5', './data/template/5_5_common_header_member_register.tpl.php', './template/mobanbus_boohee', 'common/header_member_register')
|| checktplrefresh('./template/mobanbus_boohee/common/header.htm', './template/mobanbus_boohee/common/pubsearchform.htm', 1408080420, '5', './data/template/5_5_common_header_member_register.tpl.php', './template/mobanbus_boohee', 'common/header_member_register')
;?>
