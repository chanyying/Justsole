...
0
|| checktplrefresh('./template/mobanbus_boohee/common/header.htm', './template/mobanbus_boohee/common/header_common.htm', 1408078175, '5', './data/template/5_5_common_header_portal_index.tpl.php', './template/mobanbus_boohee', 'common/header_portal_index')
|| checktplrefresh('./template/mobanbus_boohee/common/header.htm', './template/mobanbus_boohee/common/pubsearchform.htm', 1408078175, '5', './data/template/5_5_common_header_portal_index.tpl.php', './template/mobanbus_boohee', 'common/header_portal_index')
;?>
