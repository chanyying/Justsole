...
0
|| checktplrefresh('./source/plugin/mobile/template/mobile.htm', './template/mobanbus_boohee/common/header.htm', 1408123131, 'mobile', './data/template/5_mobile_mobile.tpl.php', './source/plugin/mobile/template', 'mobile')
|| checktplrefresh('./source/plugin/mobile/template/mobile.htm', './template/default/common/footer.htm', 1408123131, 'mobile', './data/template/5_mobile_mobile.tpl.php', './source/plugin/mobile/template', 'mobile')
|| checktplrefresh('./source/plugin/mobile/template/mobile.htm', './template/mobanbus_boohee/common/header_common.htm', 1408123131, 'mobile', './data/template/5_mobile_mobile.tpl.php', './source/plugin/mobile/template', 'mobile')
|| checktplrefresh('./source/plugin/mobile/template/mobile.htm', './template/mobanbus_boohee/common/pubsearchform.htm', 1408123131, 'mobile', './data/template/5_mobile_mobile.tpl.php', './source/plugin/mobile/template', 'mobile')
;?>
...
<input type="text" name="srchtxt" id="scbar_txt" value="è¯·è¾“å…¥æœç´¢å†…å®¹" autocomplete="off" x-webkit-speech speech />
...
<ul>
                    <li><a href="home.php?mod=space&amp;uid=<?php echo $space['uid'];?>"><img src="uc_server/avatar.php?uid=<?php echo $_G['uid'];?>&amp;size=small" style="width:22px; height:22px; border-radius:2px;"/>&nbsp;&nbsp;&nbsp;æˆ‘çš„ç©ºé—´</a></li>
                    <li><a href="home.php?mod=space&amp;do=doing"><img src="<?php echo IMGDIR;?>/gerenzx.png" />&nbsp;&nbsp;&nbsp;ä¸ªäººä¸­å¿ƒ</a></li>
                    <li><a href="forum.php?mod=collection&amp;op=my"><img src="<?php echo IMGDIR;?>/biaoq.png" />&nbsp;&nbsp;&nbsp;æˆ‘çš„ä¸“è¾‘</a></li>
<li><a href="home.php?mod=space&amp;do=notice"><img src="<?php echo IMGDIR;?>/messages.png" />&nbsp;&nbsp;&nbsp;æ¶ˆæ¯</a></li>
<li><a href="home.php?mod=spacecp"><img src="<?php echo IMGDIR;?>/star.png" />&nbsp;&nbsp;&nbsp;è®¾ç½®</a></li>
<li><a href="member.php?mod=logging&amp;action=logout&amp;formhash=<?php echo FORMHASH;?>"><img src="<?php echo IMGDIR;?>/searchn.png" />&nbsp;&nbsp;&nbsp;é€€å‡º</a></li>
</ul>
</div>
</div>
</li>
    ...
    <div id="header_user">
      <ul id="header_nav">
        <li class="login_list"><a href="connect.php?mod=login&amp;op=init&amp;referer=forum.php&amp;statfrom=login"><i class="i_qq">è…¾è®¯QQ</i></a></li>
        <li class="login_list"><a class="login_block"  href="member.php?mod=register" class="btn-register">ç«‹å³æ³¨å†Œ</a></li>
        <li class="login_list"><a class="login_block"  href="javascript:;" onClick="javascript:lsSubmit();" class="nousername">ç™»å½•</a></li>
      </ul>
    </div>
...
!$nav['type'] && ($nav['id'] == 'stat' && $_G['group']['allowstatdata'] || $nav['id'] == 'report' && $_G['uid'] || $nav['id'] == 'archiver' || $nav['id'] == 'mobile' || $nav['id'] == 'darkroom'))) { ?><?php echo $nav['code'];?><span class="pipe">|</span><?php } } ?>
                        ...
                        <a href="portal.php?mod=topic&amp;topicid=15">å…³äºæˆ‘ä»¬</a>&nbsp;&nbsp;
