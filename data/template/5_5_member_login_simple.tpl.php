...
<style>
.xuanzezhuce{ width:80px; height:30px; background-color:#999999; border-radius:3px;cursor:pointer; color:#FFFFFF;}
.xuanzezhuce:hover{ background-color:#00CC99; }
.xuanzedl{ width:75px; height:23px; background-color:#809BDB; border-radius:2px;cursor:pointer; color:#FFFFFF;}
.xuanzedl:hover{ background-color:#00CC99; }
</style>
...
<td class="fastlg_l"><button type="submit" class="xuanzedl" tabindex="904" style="width: 75px;"><em>登录</em></button></td>
              <tr>
                    <td align="left">&nbsp;<label for="ls_cookietime"><input type="checkbox" name="cookietime" id="ls_cookietime" class="pc" value="2592000" tabindex="903" />自动登录</label></td>
<td align="left">&nbsp;<a href="javascript:;" onclick="showWindow('login', 'member.php?mod=logging&action=login&viewlostpw=1')">找回密码</a></td>
<td align="left">&nbsp;<a href="member.php?mod=<?php echo $_G['setting']['regname'];?>" class="xi2 xw1"><?php echo $_G['setting']['reglinkname'];?></a></td>
              </tr>
</tr>
  </table></td>
</table>
