...
block_get('1692,1691');?><?php include template('common/header'); if(empty($gid)) { ?><?php echo adshow("text/wp a_t");?><?php } ?>
...
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameMcVKtx" class="frame move-span cl frame-1"><div id="frameMcVKtx_left" class="column frame-1-c"><div id="frameMcVKtx_left_temp" class="move-span temp"></div><?php block_display('1692');?></div></div><div id="framewpzTVf" class="frame move-span cl frame-1"><div id="framewpzTVf_left" class="column frame-1-c"><div id="framewpzTVf_left_temp" class="move-span temp"></div></div></div><div id="frame5N4Ey8" class="frame move-span cl frame-1"><div id="frame5N4Ey8_left" class="column frame-1-c"><div id="frame5N4Ey8_left_temp" class="move-span temp"></div></div></div><div id="frame2G92TE" class="frame move-span cl frame-1"><div id="frame2G92TE_left" class="column frame-1-c"><div id="frame2G92TE_left_temp" class="move-span temp"></div></div></div><div id="frameECp2KK" class="frame move-span cl frame-1"><div id="frameECp2KK_left" class="column frame-1-c"><div id="frameECp2KK_left_temp" class="move-span temp"></div><?php block_display('1691');?></div></div></div><!--[/diy]-->
</div>
