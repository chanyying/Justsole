...
0
|| checktplrefresh('./template/mobanbus_boohee/common/header.htm', './template/mobanbus_boohee/common/header_common.htm', 1408078474, '5', './data/template/5_5_common_header_forum_viewthread.tpl.php', './template/mobanbus_boohee', 'common/header_forum_viewthread')
|| checktplrefresh('./template/mobanbus_boohee/common/header.htm', './template/mobanbus_boohee/common/pubsearchform.htm', 1408078474, '5', './data/template/5_5_common_header_forum_viewthread.tpl.php', './template/mobanbus_boohee', 'common/header_forum_viewthread')
;?>
