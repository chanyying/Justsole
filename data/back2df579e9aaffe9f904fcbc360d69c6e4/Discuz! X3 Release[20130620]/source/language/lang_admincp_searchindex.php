...
$lang = array (
  ...
  array (
    'index' =>
    array (
      '创始人权限' => 'action=group&operation=userperm',
    ),
    'text' =>
    array (
      0 => '创始人权限',
  ...
  array (
    ...
    array (
      ...
      13 => '允许 DIY',
      14 => '设置是否允许 DIY 交流版块，文章，空间，交流版块等页面',
    ),
  ),
  154 =>
  array (
  ...
  array (
    ...
    array (
      ...
      18 => '备份文件名',
      19 => 'db_import_tips',
      20 => '本功能在恢复备份数据的同时，将全部覆盖原有数据，请确定恢复前已将交流版块关闭，恢复全部完成后可以将交流版块重新开放。恢复数据前请在 Discuz! X2.5 安装文件目录下utility文件夹内找到 restore.php 文件，然后将 restore.php 文件上传到程序文件夹data目录下。为了您站点的安全，成功恢复数据后请务必及时删除 restore.php 文件。您可以在数据备份记录处查看站点的备份文件的详细信息，删除过期的备份,并导入需要的备份。',
      21 => 'db_import',
      22 => '数据恢复',
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      2 => '可以为个人空间、圈子、版块、专题、频道设置一个二级域名的根域名。例：用户申请XXX.comsenz.com,根域名填：comsenz.com个人空间、圈子设置完二级域名的根后，还需要在基本设置中开启相应的二级域名开关，用户才能在相应的地方申请绑定二级域名，同时受限于用户组的二级域名长度频道启用二级域名如果是绑定目录的，需要自已在环境中配置相关的绑定操作不建议中途将不同的根域变更为相同的根域',
    ),
  ),
  182 =>
  array (
    ...
    array (
      ...
      2 => '保留二级域名设置后所有人都无法申请或使用该域名个人空间、圈子的二级域名开启后需要到根域名设置中设置圈子、家园的根域名',
  ...
  array (
    ...
    array (
      0 => '电子商务 &raquo; 支付宝',
      1 => 'ec_alipay_tips',
      2 => '“支付宝”(http://www.alipay.com)是中国领先的网上支付平台，由全球最佳 B2B 公司阿里巴巴公司创建，为 Discuz! 用户提供积分购买及交流版块 B2C、C2C 交易平台。您只需进行简单的设置，即可使交流版块内容和人气，真成为除广告收入外的重要利润来源，从而实现交流版块的规模化经营。由于涉及现金交易，为避免因操作不当而造成的资金损失，请在开始使用支付宝积分交易功能(不包含支付宝按钮功能)前，务必仔细阅读《用户使用说明书》中有关电子商务的部分，当确认完全理解和接受相关流程及使用方法后再进行相关设置。您可以设置允许用户通过现金在线支付的方式，为其交易积分账户充值，用于购买帖子内容、购买用户组权限、积分转账或用户组升级等功能。支付宝积分交易功能，需在“积分设置”中启用交易积分，并同时设置相应的积分策略以满足不同场合的需要。请务必正确设置您的收款支付宝账号，否则将造成用户付款后积分无法实时到账，造成大量需要人工处理的订单信息。除 Discuz! 官方网站或官方交流版块另行通知以外，Discuz! 提供的支付宝支付服务每笔交易收取 1.5% 的手续费。请及时关注相关业务的最新通知，各项政策或流程的变更、调整，以 Discuz! 官方网站或官方交流版块提供的信息为准。您使用支付宝服务是建立在完全自愿的基础上，除 Discuz! 因主观恶意的因素造成的资金损失以外，北京康盛新创科技有限责任公司不对因使用此功能造成的任何损失承担责任。支付宝业务咨询 Email 为 6688@taobao.com；支付宝客户服务电话为 +86-0571-88156688。',
      3 => 'ec_alipay',
      4 => '支付宝设置',
      5 => 'ec_alipay_account',
      6 => '收款支付宝账号',
...
由于涉及现金交易，为避免因操作不当而造成的资金损失，请在开始使用财付通积分交易功能(不包含财付通按钮功能)前，务必仔细阅读《用户使用说明书》中有关电子商务的部分，当确认完全理解和接受相关流程及使用方法后再进行相关设置。您可以设置允许用户通过现金在线支付的方式，为其交易积分账户充值，用于购买帖子内容、购买用户组权限、积分转账或用户组升级等功能。财付通积分交易功能，需在“积分设置”中启用交易积分，并同时设置相应的积分策略以满足不同场合的需要。请务必正确设置您的收款财付通账号，否则将造成用户付款后积分无法实时到账，造成大量需要人工处理的订单信息。除 Discuz! 官方网站或官方交流版块另行通知以外，Discuz! 提供的财付通支付服务每笔交易收取 1% 的手续费。请及时关注相关业务的最新通知，各项政策或流程的变更、调整，以 Discuz! 官方网站或官方交流版块提供的信息为准。您使用财付通服务是建立在完全自愿的基础上，除 Discuz! 因主观恶意的因素造成的资金损失以外，北京康盛新创科技有限责任公司不对因使用此功能造成的任何损失承担责任。财付通服务热线：0755-83762288-2(全天24小时服务热线)',
  ...
  array (
    ...
    array (
      ...
      9 => '交流版块首页下级子版块横排',
      10 => '设置进入交流版块首页时下级子版块横排时每行版块数量，如果设置为 0，则按正常方式排列',
  ...
  array (
    ...
    array (
      ...
      9 => '交流版块下级子版块横排',
      10 => '设置进入交流版块时下级子版块横排时每行版块数量，如果设置为 0，则按正常方式排列',
      ...
      18 => '交流版块下级子版块横排',
      19 => '设置进入交流版块时下级子版块横排时每行版块数量，如果设置为 0，则按正常方式排列',
      ...
      51 => '关联圈子/版块',
      52 => '填写被关联圈子/版块的fid，以半角逗号 "," 隔开。版块的主题列表页将显示被关联圈子/版块的主题',
  ...
  array (
    ...
    array (
      ...
      9 => '圈子图标文件大小(单位：KB)',
      10 => '设置圈子图标文件的最大尺寸，0 或留空为不限制',
      11 => 'groups_setting_basic_recommend',
      12 => '推荐圈子',
      13 => '填写要推荐到圈子首页的圈子 ID，以半角逗号 "," 隔开，最多显示 8 个，如不足8个会自动补充积分最高的圈子。例：“23,56,983”',
      14 => 'groups_setting_admingroup',
      15 => '选择管理用户组(在圈子中具有与交流版块中相对应的管理权限)',
  ...
  array (
    ...
    array (
      0 => '友情链接',
      1 => 'misc_link_tips',
      2 => '如果您不想在交流版块首页显示友情链接，可以在“界面设置”中关闭。未填写文字说明的项目将以紧凑型显示。
  ...
  array (
    ...
    array (
      0 => '词语过滤',
      1 => 'misc_censor_tips',
      2 => '替换前的内容可以使用限定符 {x} 以限定相邻两字符间可忽略的文字，x 是忽略的字节数。如 "a{1}s{2}s"(不含引号) 可以过滤 "ass" 也可过滤 "axsxs" 和 "axsxxs" 等等。对于中文字符，若使用 GBK、Big-5 版本，每个中文字符相当于 2 个字节；若使用 UTF-8 版本，每个中文字符相当于 3 个字节。为不影响程序效率，请不要设置过多不需要的过滤内容。审核只对交流版块中的内容有效如果您不是交流版块管理员，您将只能对自己添加的项目进行编辑或删除。不良词语如果以"/"(不含引号)开头和结尾则表示格式为正则表达式，这时替换内容可用"(n)"引用正则中的子模式，如"/1\\d{10}([^\\d]+|$)/"替换为"手机(1)"。',
      3 => 'misc_censor_batch_add_tips',
      4 => '每行一组过滤词语，不良词语和替换词语之间使用“=”进行分割；如需禁止发布包含某个词语的文字，而不是替换过滤，请将其对应的替换内容设置为{BANNED}即可；如需当用户发布包含某个词语的文字时，自动标记为需要人工审核，而不直接显示或替换过滤，请将其对应的替换内容设置为{MOD}即可(审核只对交流版块中的内容有效)。如果只是想将某个词语直接替换成 **，则只输入词语即可；例如：toobadnobadbadword=goodsexword={BANNED}导出/导入时支持词语分类导入，导入时不带有分类则可以通过选择指定导入分类。没有分类时自动归入默认分类',
...
',
  ...
  array (
    ...
    array (
      ...
      18 => '站点宽窄风格',
      19 => '设置站点的显示风格是宽版还是窄版。其中交流版块的版块中还可以进行独立的设置',
  ...
  array (
    ...
    array (
      '界面设置' => 'action=setting&operation=styles',
      '交流版块首页' => 'action=setting&operation=styles&anchor=index',
    ),
    'text' =>
    array (
      0 => '界面设置 &raquo; 交流版块首页',
      ...
      25 => '显示边栏',
      26 => '选择“是”交流版块首页侧边将显示聚合交流版块内容的信息',
      27 => 'setting_styles_index_whosonline',
      28 => '显示在线用户',
      29 => '设置是否在交流版块首页底部和交流版块边栏显示在线会员列表',
  ...
  array (
    ...
    array (
      ...
      18 => '启用全局置顶',
      19 => '选择“是”，置顶 III 的主题将在全部交流版块显示，置顶 II 的主题将在当前分区中显示。注意: 本功能会加重服务器负担',
  ...
  array (
    ...
    array (
      ...
      66 => '作者用户名显示位置',
      67 => '显示位置并不会影响交流版块的性能和美观，请根据您会员的浏览习惯进行选择',
  ...
  array (
    ...
    array (
      '性能优化' => 'action=setting&operation=seo',
      '交流版块页面缓存设置' => 'action=setting&operation=cachethread',
    ),
    'text' =>
    array (
      0 => '性能优化 &raquo; 交流版块页面缓存设置',
      1 => 'setting_cachethread',
      2 => '交流版块页面缓存设置',
      3 => '开启后，缓存页面内容到静态文件，游客访问时速度将大大提升，建议独立服务器使用，虚拟空间请根据实际情况调节缓存的有效期',
      4 => 'setting_cachethread_indexlife',
      5 => '缓存交流版块首页有效期',
      6 => '设置交流版块首页缓存更新的时间，单位为秒，0 为关闭(此处关闭以后，缓存系数将不再起作用)，建议设置为 900。此功能只针对游客',
      7 => 'setting_cachethread_life',
      8 => '缓存帖子有效期',
      9 => '设置帖子页面缓存更新的时间，单位为秒，0 为关闭。请根据实际情况进行调整，建议设置为 900。另外，请通过编辑交流版块来指定帖子页面缓存系数',
      ...
      16 => '缓存系数',
      17 => '页面缓存功能可以将会员经常访问的主题临时缓存起来，缓解大型交流版块服务器压力。缓存阀值范围 0 - 100，建议设置为 40 ，0 为关闭。在磁盘空间允许的情况下，适当调高缓存系数，可以提高缓存效果',
  ...
  array (
    ...
    array (
      ...
      35 => '是否关闭session机制',
      36 => '关闭session机制以后，可明显降低站点的服务器负担，建议在线用户数超过2万时开启本功能（注意：游客数和用户的在线时长将不再进行统计，交流版块首页和版块列表页面的在线用户列表功能将不可用）',
  ...
  array (
    ...
    array (
      ...
      7 => '开启交流版块管理工作统计',
      8 => '交流版块管理工作统计可以使版主、管理员了解交流版块版主等管理人员的工作状况。注意: 本功能会轻微加重系统负担',
      9 => 'setting_functions_archiver',
      10 => '开启交流版块 Archiver 功能',
      11 => '交流版块 Archiver 能够将交流版块公开的内容模拟成静态页面，以便搜索引擎获取其中的内容',
  ...
  array (
    ...
    array (
      '上传设置' => 'action=setting&operation=attach',
      '交流版块附件' => 'action=setting&operation=attach&anchor=forumattach',
    ),
    'text' =>
    array (
      0 => '上传设置 &raquo; 交流版块附件',
  ...
  array (
    ...
    array (
      '水印设置' => 'action=setting&operation=imgwater',
      '交流版块' => 'action=setting&operation=imgwater&anchor=forum',
    ),
    'text' =>
    array (
      0 => '水印设置 &raquo; 交流版块',
...
(3)SPH_RANK_NONE，禁用评分的模式，这是最快的模式。实际上这种模式与布尔搜索相同。所有的匹配项都被赋予权重1',
  ...
  array (
    ...
    array (
      ...
      9 => '不参与排行的版块/圈子',
      10 => '填入版块ID或圈子ID，对应版块及下面的主题将不进入排行榜，多个版块ID间请用半角逗号 "," 隔开',
  ...
  array (
    ...
    array (
      ...
      2 => '提供方便手机方式浏览的页面，此功能仅限交流版块范围内。本手机功能页仅支持WAP2.0(XHTML方式)以上的手机浏览器进行访问。手机浏览图片宽度为200像素以内缩略图。',
      3 => 'setting_mobile_status',
      4 => '手机版全局设置',
      5 => 'setting_mobile_allowmobile',
      6 => '开启手机版',
      7 => '开启本功能，用户使用手机访问交流版块时，将自动跳转到手机版界面手机访问域名配置请进入: 全局 - 域名设置 - 应用域名底部导航设置请进入：界面 - 导航设置 - 底部导航',
      8 => 'setting_mobile_mobileforward',
      9 => '开启手机浏览器自动跳转',
      10 => '开启后用户使用手机浏览器访问社区交流版块功能页以外页面时自动跳转到交流版块首页进行访问',
      ...
      33 => '首页分区展示方式',
      34 => '如“收起”，交流版块首页将默认只展示分区标题用户需点击分区展开该分区下的版块列表',
  ...
  array (
    ...
    array (
      ...
      2 => '当站点进行了数据恢复、升级或者工作出现异常的时候，您可以使用本功能重新生成缓存。更新缓存的时候，可能让服务器负载升高，请尽量避开会员访问的高峰时间
				数据缓存：更新站点的全部数据缓存
				模板缓存：更新交流版块模板、风格等缓存文件，当您修改了模板或者风格，但是没有立即生效的时候使用
  ...
  array (
    ...
    array (
      ...
      43 => '允许全文搜索',
      44 => '此设置只对搜索交流版块有效。注意: 当数据量大时，全文搜索将非常耗费服务器资源，请慎用',
  ...
  array (
    ...
    array (
      ...
      16 => '允许发匿名帖',
      17 => '是否允许用户匿名发表主题和回复，只要用户组或本交流版块允许，用户均可使用匿名发帖功能。匿名发帖不同于游客发帖，用户需要登录后才可使用，版主和管理员可以查看真实作者',
  ...
  array (
    ...
    array (
      ...
      4 => '允许下载附件',
      5 => '设置是否允许在没有设置特殊权限的交流版块中下载附件',
      6 => 'usergroups_edit_attach_getimage',
      7 => '允许查看图片',
      8 => '设置是否允许在没有设置特殊权限的交流版块中查看图片',
      9 => 'usergroups_edit_attach_post',
      10 => '允许上传附件',
      11 => '设置是否允许上传附件到没有设置特殊权限的交流版块中。需要 PHP 设置允许才有效，请参考管理中心首页',
      12 => 'usergroups_edit_attach_set_perm',
      13 => '允许设置附件权限',
      14 => '设置是否允许设置附件需要指定积分以上才可下载',
      15 => 'usergroups_edit_image_post',
      16 => '允许上传图片',
      17 => '设置是否允许上传图片到没有设置特殊权限的交流版块中。需要 PHP 设置允许才有效，请参考管理中心首页',
      18 => 'usergroups_edit_attach_max_size',
      19 => '交流版块最大附件尺寸(单位K 1M=1024K)',
