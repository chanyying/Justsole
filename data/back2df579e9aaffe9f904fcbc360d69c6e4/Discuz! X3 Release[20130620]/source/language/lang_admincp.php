...
(
	...
	'setting_access_register_connect_uinlimit' => '同一QQ帐号最多可创建交流版块帐号的个数',
	'setting_access_register_connect_uinlimit_comment' => '一个QQ帐号无论绑定/解绑多少次，通过此QQ帐号最多可以创建交流版块新帐号的个数，0 或留空为不限制',
	...
	'setting_styles_global_stylejump_comment' => '设置是否显示可用的站点风格切换按钮，用户可以此按钮切换不同的站点风格',
    	'setting_styles_global_jsmenu' => '<span class="spectitle">交流版块显示版块跳转菜单</span>',
	'setting_styles_global_jsmenu_comment' => '注意: 当交流版块分版块很多时，本功能会严重加重服务器负担',
	...
	'setting_styles_global_home_style_0' => '以交流版块模块风格展示',
	...
	'setting_styles_global_homepage_style_0' => '交流版块样式',
	...
	'setting_styles_index' => '交流版块首页',
	'setting_styles_index_allowindextype' => '在首页切换显示风格',
	'setting_styles_index_indextype' => '首页显示风格',
	'setting_styles_index_indextype_comment' => '设置交流版块首页的默认显示风格',
	'setting_styles_index_indextype_classics' => '经典版块列表',
	'setting_styles_index_indextype_feeds' => '交流版块实时动态',
	'setting_styles_index_indexhot_status' => '交流版块热点',
	'setting_styles_index_indexhot_status_comment' => '设置是否显示全交流版块的热点主题',
	'setting_styles_index_indexhot_limit' => '交流版块热点显示数量',
	'setting_styles_index_indexhot_limit_comment' => '设置交流版块热点条目数，默认值 10 条',
	'setting_styles_index_indexhot_days' => '交流版块热点天数',
	'setting_styles_index_indexhot_days_comment' => '设置显示多少天内的主题，默认值 7 天',
	'setting_styles_index_indexhot_expiration' => '交流版块热点更新周期(秒)',
	'setting_styles_index_indexhot_expiration_comment' => '设置交流版块热点在多长时间更新一次，默认值 900',
	'setting_styles_index_indexhot_messagecut' => '交流版块热点内容截取文字长度',
	'setting_styles_index_indexhot_messagecut_comment' => '设置交流版块热点内容的文字长度，默认值 200 个字',
	'setting_styles_index_allowwidthauto' => '站点宽窄风格',
	'setting_styles_index_allowwidthauto_comment' => '设置站点的显示风格是宽版还是窄版。其中交流版块的版块中还可以进行独立的设置',
	...
	'setting_styles_index_forumallowside_comment' => '选择“是”交流版块首页侧边将显示聚合交流版块内容的信息',
	'setting_styles_index_whosonline' => '显示在线用户',
	'setting_styles_index_display_none' => '不显示',
	'setting_styles_index_whosonline_comment' => '设置是否在交流版块首页底部和交流版块版块边栏显示在线会员列表',
	...
	'setting_styles_index_whosonline_index' => '仅在交流版块首页显示',
	'setting_styles_index_whosonline_forum' => '仅在交流版块版块显示',
	'setting_styles_index_whosonline_both' => '在交流版块首页和交流版块版块显示',
	...
	'setting_styles_forumdisplay_globalstick_comment' => '选择“是”，置顶 III 的主题将在全部交流版块显示，置顶 II 的主题将在当前分区中显示。注意: 本功能会加重服务器负担',
	...
	'setting_styles_viewthread_author_onleft_comment' => '显示位置并不会影响交流版块的性能和美观，请根据您会员的浏览习惯进行选择',
	...
	'setting_home_privacy_default_feed_newthread' => '交流版块发帖',
	'setting_home_privacy_default_feed_newreply' => '交流版块回帖',
...
',
	...
	'misc_focus_position_forum' => '交流版块',
	...
	'setting_seo_rewritestatus_forum_forumdisplay' => '交流版块主题列表页',
	'setting_seo_rewritestatus_forum_viewthread' => '交流版块主题内容页',
	...
	'setting_seo_rewritestatus_forum_archiver' => '交流版块 Archiver 页',
	...
	'setting_cachethread' => '交流版块页面缓存设置',
	'setting_cachethread_comment' => '开启后，缓存页面内容到静态文件，游客访问时速度将大大提升，建议独立服务器使用，虚拟空间请根据实际情况调节缓存的有效期',
	'setting_cachethread_indexlife' => '缓存交流版块首页有效期',
	'setting_cachethread_indexlife_comment' => '设置交流版块首页缓存更新的时间，单位为秒，0 为关闭(此处关闭以后，缓存系数将不再起作用)，建议设置为 900。此功能只针对游客',
	'setting_cachethread_life' => '缓存帖子有效期',
	'setting_cachethread_life_comment' => '设置帖子页面缓存更新的时间，单位为秒，0 为关闭。请根据实际情况进行调整，建议设置为 900。另外，请通过编辑交流版块来指定帖子页面缓存系数',
	...
	'setting_cachethread_coefficient_comment' => '页面缓存功能可以将会员经常访问的主题临时缓存起来，缓解大型交流版块服务器压力。缓存阀值范围 0 - 100，建议设置为 40 ，0 为关闭。在磁盘空间允许的情况下，适当调高缓存系数，可以提高缓存效果',
	'setting_cachethread_coefficient_forum' => '请选择要设置的交流版块',
	...
	'setting_memory_func_forumindex' => '交流版块首页',
	...
	'setting_serveropti_sessionclose_comment' => '关闭session机制以后，可明显降低站点的服务器负担，建议在线用户数超过2万时开启本功能（注意：游客数和用户的在线时长将不再进行统计，交流版块首页和版块列表页面的在线用户列表功能将不可用）',
	...
	'setting_functions_mod_status' => '<span class="spectitle">开启交流版块管理工作统计</span>',
	'setting_functions_archiver' => '开启交流版块 Archiver 功能',
	'setting_functions_archiver_comment' => '交流版块 Archiver 能够将交流版块公开的内容模拟成静态页面，以便搜索引擎获取其中的内容',
	...
	'setting_functions_mod_status_comment' => '交流版块管理工作统计可以使版主、管理员了解交流版块版主等管理人员的工作状况。注意: 本功能会轻微加重系统负担',
	...
	'setting_attach_forumattach' => '交流版块附件',
	...
	'setting_attach_image_thumbstatus' => '交流版块帖子附件缩略图设置',
	...
	'setting_imgwater_image_watermarks_forum' => '交流版块附件图片水印设置',
	...
	'setting_search_status_forum' => '搜索交流版块',
...
<br />(3)SPH_RANK_NONE，禁用评分的模式，这是最快的模式。实际上这种模式与布尔搜索相同。所有的匹配项都被赋予权重1',
	...
	'setting_mobile_status_tips' => '<li>提供方便手机方式浏览的页面，此功能仅限交流版块范围内。</li><li>本手机功能页仅支持WAP2.0(XHTML方式)以上的手机浏览器进行访问。</li><li>手机浏览图片宽度为200像素以内缩略图。</li>',
	'setting_mobile_allowmobile' => '开启手机版',
	'setting_mobile_allowmobile_comment' => '开启本功能，用户使用手机访问交流版块时，将自动跳转到手机版界面<br />手机访问域名配置请进入: <a href="?action=domain&operation=app">全局 - 域名设置 - 应用域名</a><br />底部导航设置请进入：<a href="?action=nav&operation=footernav">界面 - 导航设置 - 底部导航</a>',
	'setting_mobile_mobileforward' => '开启手机浏览器自动跳转',
	'setting_mobile_mobileforward_comment' => '开启后用户使用手机浏览器访问社区交流版块功能页以外页面时自动跳转到交流版块首页进行访问',
	...
	'setting_mobile_index_forumview_comment' => '如“收起”，交流版块首页将默认只展示分区标题<br />用户需点击分区展开该分区下的版块列表',
	...
	'forums_grid' => '首页四格',
	'forums_grid_tips' => '<li>开启后在交流版块首页会显示四格内容推荐</li>',
	'forums_grid_show_grid' => '是否开启首页四格',
	'forums_grid_show_grid_comment' => '在交流版块首页展示四格内容',
	...
	'forums_grid_cache_life_comment' => '设置交流版块首页四格缓存更新的时间，单位为秒，0代表默认600秒',
	'show_all' => '全部展开',
	'hide_all' => '全部折叠',
	...
	'forums_edit_extend_forum_horizontal' => '交流版块首页下级子版块横排',
	'forums_edit_extend_forum_horizontal_comment' => '设置进入交流版块首页时下级子版块横排时每行版块数量，如果设置为 0，则按正常方式排列',
	'forums_edit_extend_sub_horizontal' => '交流版块版块下级子版块横排',
	'forums_edit_extend_sub_horizontal_comment' => '设置进入交流版块版块时下级子版块横排时每行版块数量，如果设置为 0，则按正常方式排列',
	...
	'forums_edit_threadtypes_tips' => '<ul><li>“主题分类”用于给分版块中的主题进行归类。作者在发表新主题时，可以按照预设的类型给主题归类；用户也可以在版块中按照类别地进行浏览(需在“编辑版块”中设定)。与子版块功能不同的是，主题分类只用来归类特定版块中的帖子，适用于相关性大而又需要某种分类的情况。</ul><ul><li>“主题分类”是全交流版块共用的，您可以在“编辑版块”中设置当前版块以某些类型来将主题分类。</ul><ul><li>如果您将某些主题分类更名、删除或修改显示顺序，请编辑与此分类相关联的版块(不需做任何改动)后提交，主题分类才能被更新。</ul>',
	...
	'forums_moderators_tips' => '<li>“由上级版块继承”表示该版主是由上级版块或分类继承而来，而不是针对本版块独立设置的设置的版主，不能单独删除。</li><li>“将本版块或分类版主的权力继承到下级版块”在当前交流版块是分类时，默认为选定状态；在当前版块是子版块时，默认为不选状态。</li>',
	...
	'styles_edit_visual_text' => '<p id="sp_tabletext" style="margin: 0; line-height: 1.6em; color: #444;"><a id="sp_link" href="http://www.discuz.net" target="_blank" style="color: #09C; text-decoration: none;">Crossday Discuz! Board</a> 交流版块系统<span id="sp_midtext" style="color: #666;">(简称 <strong id="sp_notice" style="color: #F60;">Discuz!</strong> 交流版块)</span>是一个采用 PHP 和 MySQL 等其他多种数据库构建的高效建站解决方案。</p>',
	...
	'admingroup_edit_diy_comment' => '设置是否允许 DIY 交流版块，文章，空间，交流版块等页面',
	...
	'usergroups_edit_basic_search_post_comment' => '此设置只对搜索交流版块有效。注意: 当数据量大时，全文搜索将非常耗费服务器资源，请慎用',
	...
	'usergroups_edit_forum' => '交流版块相关',
	'usergroups_edit_special' => '特殊主题',
	'usergroups_edit_special_poll' => '允许发起投票',
	'usergroups_edit_special_poll_comment' => '选择“是”允许在交流版块发布投票主题',
	'usergroups_edit_special_vote' => '允许参与投票',
	'usergroups_edit_special_vote_comment' => '选择“是”允许在交流版块参与投票',
	'usergroups_edit_special_activity' => '允许发起活动',
	'usergroups_edit_special_activity_comment' => '选择“是”允许在交流版块发布活动主题',
	'usergroups_edit_special_reward' => '允许发起悬赏',
	'usergroups_edit_special_reward_comment' => '选择“是”允许在交流版块发布悬赏主题，悬赏使用交易积分',
	...
	'usergroups_edit_special_trade_comment' => '选择“是”允许在交流版块发布商品主题',
	...
	'usergroups_edit_special_debate_comment' => '选择“是”允许在交流版块发布辩论主题',
	...
	'usergroups_edit_post_anonymous_comment' => '是否允许用户匿名发表主题和回复，只要用户组或本交流版块允许，用户均可使用匿名发帖功能。匿名发帖不同于游客发帖，用户需要登录后才可使用，版主和管理员可以查看真实作者',
	...
	'usergroups_edit_attach_get_comment' => '设置是否允许在没有设置特殊权限的交流版块中下载附件',
	'usergroups_edit_attach_getimage' => '允许查看图片',
	'usergroups_edit_attach_getimage_comment' => '设置是否允许在没有设置特殊权限的交流版块中查看图片',
	'usergroups_edit_attach_post' => '允许上传附件',
	'usergroups_edit_attach_post_comment' => '设置是否允许上传附件到没有设置特殊权限的交流版块中。需要 PHP 设置允许才有效，请参考管理中心首页',
	'usergroups_edit_image_post' => '允许上传图片',
	'usergroups_edit_image_post_comment' => '设置是否允许上传图片到没有设置特殊权限的交流版块中。需要 PHP 设置允许才有效，请参考管理中心首页',
	...
	'usergroups_edit_attach_max_size' => '交流版块最大附件尺寸(单位K 1M=1024K)',
	...
	'usergroups_edit_credit_exempt_comment' => '以上项目中，选择“是”表示本组用户将不执行相应的扣积分操作，选择“否”将使用交流版块默认或版块设定的规则',
	...
	'groups_setting_admingroup' => '选择管理用户组(在圈子中具有与交流版块中相对应的管理权限)',
	...
	'threads_forumstick_targets' => '选择目标交流版块',
	'threads_forumstick_targets_comment' => '指定的主题会在这些交流版块中置顶显示，可以按住 CTRL 多选',
	...
	'quickquery_open_forum' => '快速开启交流版块功能',
	...
	'quickquery_close_forum' => '快速关闭交流版块功能',
	...
	'misc_link_tips' => '<li>如果您不想在交流版块首页显示友情链接，可以在“<a href="'.ADMINSCRIPT.'?action=setting&operation=styles&anchor=index">界面设置</a>”中关闭。</li><li>未填写文字说明的项目将以紧凑型显示。</li>
	...
	'misc_relatedlink_extent_forum' => '交流版块主题',
	...
	'plugins_edit_modules_type_15' => '交流版块管理 - 基本',
	'plugins_edit_modules_type_16' => '交流版块管理 - 工具',
	...
	'tasks_tips_add_member' => '<li>会员类任务目前包括三种：添加好友、收藏主题、使用道具，此类任务用来鼓励和引导会员使用交流版块的某个功能，活跃交流版块的氛围。</li><li>设置不同的完成任务条件，可以创造出适合您交流版块的任务。</li>',
	...
	'ec_alipay' => '支付宝设置',
	'ec_alipay_tips' => '<li>“支付宝”(<a href="http://www.alipay.com" target="_blank">http://www.alipay.com</a>)是中国领先的网上支付平台，由全球最佳 B2B 公司阿里巴巴公司创建，为 Discuz! 用户提供积分购买及交流版块 B2C、C2C 交易平台。您只需进行简单的设置，即可使交流版块内容和人气，真成为除广告收入外的重要利润来源，从而实现交流版块的规模化经营。</li><li><b>由于涉及现金交易，为避免因操作不当而造成的资金损失，请在开始使用支付宝积分交易功能(不包含支付宝按钮功能)前，务必仔细阅读《用户使用说明书》中有关电子商务的部分，当确认完全理解和接受相关流程及使用方法后再进行相关设置。</b></li><li>您可以设置允许用户通过现金在线支付的方式，为其交易积分账户充值，用于购买帖子内容、购买用户组权限、积分转账或用户组升级等功能。支付宝积分交易功能，需在“<a href="'.$BASESCRIPT.'?action=setting&operation=credits" target="_blank">积分设置</a>”中启用交易积分，并同时设置相应的积分策略以满足不同场合的需要。请务必正确设置您的收款支付宝账号，否则将造成用户付款后积分无法实时到账，造成大量需要人工处理的订单信息。</li><li>除 Discuz! 官方网站或官方交流版块另行通知以外，Discuz! 提供的支付宝支付服务每笔交易收取 1.5% 的手续费。请及时关注相关业务的最新通知，各项政策或流程的变更、调整，以 Discuz! 官方网站或官方交流版块提供的信息为准。</li><li>您使用支付宝服务是建立在完全自愿的基础上，除 Discuz! 因主观恶意的因素造成的资金损失以外，北京康盛新创科技有限责任公司不对因使用此功能造成的任何损失承担责任。</li><li>支付宝业务咨询 Email 为 <a href="mailto:6688@taobao.com">6688@taobao.com</a>；支付宝客户服务电话为 +86-0571-88156688。</li>',
	...
	'ec_alipay_contract_comment' => '如果您的支付宝账号是签约用户，可以选择“是”让交流版块使用您自己的商家服务平台。如果您还未签约，<a href="http://act.life.alipay.com/systembiz/discuz/" target="_blank">请点击这里签约</a>',
...
<li><b>由于涉及现金交易，为避免因操作不当而造成的资金损失，请在开始使用财付通积分交易功能(不包含财付通按钮功能)前，务必仔细阅读《用户使用说明书》中有关电子商务的部分，当确认完全理解和接受相关流程及使用方法后再进行相关设置。</b></li><li>您可以设置允许用户通过现金在线支付的方式，为其交易积分账户充值，用于购买帖子内容、购买用户组权限、积分转账或用户组升级等功能。财付通积分交易功能，需在“积分设置”中启用交易积分，并同时设置相应的积分策略以满足不同场合的需要。请务必正确设置您的收款财付通账号，否则将造成用户付款后积分无法实时到账，造成大量需要人工处理的订单信息。</li><li>除 Discuz! 官方网站或官方交流版块另行通知以外，Discuz! 提供的财付通支付服务每笔交易收取 1% 的手续费。请及时关注相关业务的最新通知，各项政策或流程的变更、调整，以 Discuz! 官方网站或官方交流版块提供的信息为准。</li><li>您使用财付通服务是建立在完全自愿的基础上，除 Discuz! 因主观恶意的因素造成的资金损失以外，北京康盛新创科技有限责任公司不对因使用此功能造成的任何损失承担责任。</li><li>财付通服务热线：0755-83762288-2(全天24小时服务热线)</li>',
	...
	'project_option_group_allowvisit' => '允许访问交流版块',
	...
	'project_option_group_allowcstatus' => '允许查看交流版块统计',
	...
	'extended_tag' => '标签聚合',
	'extended_tag_tips' => '<li>交流版块当前未开启主题标签功能，标签聚合开启后将无法根据主题的相关内容显示。<a href="'.ADMINSCRIPT.'?action=setting&operation=functions&anchor=tags">点这里打开主题标签功能</a></li>',
	...
	'tools_updatecache_tips' => '<li>当站点进行了数据恢复、升级或者工作出现异常的时候，您可以使用本功能重新生成缓存。更新缓存的时候，可能让服务器负载升高，请尽量避开会员访问的高峰时间</li>
				...
				<li>模板缓存：更新交流版块模板、风格等缓存文件，当您修改了模板或者风格，但是没有立即生效的时候使用</li>
	...
	'filecheck_tips' => '<li>当交流版块出现异常或者被非法入侵后，您应当使用本功能校验交流版块程序文件，以确保交流版块安全运行</li><li>“<font color="red">丢失</font>”的文件您应当通过 FTP 及时将文件补充进来，否则可能交流版块运行不正常</li><li>“<font color="red">被修改</font>”、“<font color="red">未知</font>”的文件应当引起您的警惕，必须确认文件是您自己修改或者是某个插件添加的，否则请删除未知文件和恢复被修改的文件</li>',
	...
	'db_import_tips' => '<li>本功能在恢复备份数据的同时，将全部覆盖原有数据，请确定恢复前已将交流版块关闭，恢复全部完成后可以将交流版块重新开放。</li><li>恢复数据前请在 Discuz! X2.5 安装文件目录下utility文件夹内找到 restore.php 文件，然后将 restore.php 文件上传到程序文件夹data目录下。<b>为了您站点的安全，成功恢复数据后请务必及时删除 restore.php 文件。</b></li><li>您可以在数据备份记录处查看站点的备份文件的详细信息，删除过期的备份,并导入需要的备份。</li>',
	...
	'adv_type_headerbanner_tips' => '<li>展现方式: 页头通栏广告显示于交流版块页面右上方，通常使用 468x60 图片或 Flash 的形式。当前页面有多个页头通栏广告时，系统会随机选取其中之一显示。</li><li>价值分析: 由于能够在页面打开的第一时间将广告内容展现于最醒目的位置，因此成为了网页中价位最高、最适合进行商业宣传或品牌推广的广告类型之一。</li>',
	'adv_type_footerbanner' => '页尾通栏广告',
	'adv_type_footerbanner_tips' => '<li>展现方式: 页尾通栏广告显示于交流版块页面中下方，通常使用 468x60 或其他尺寸图片、Flash 的形式。当前页面有多个页尾通栏广告时，系统会随机选取其中之一显示。</li><li>价值分析: 与页面头部和中部相比，页面尾部的展现机率相对较低，通常不会引起访问者的反感，同时又基本能够覆盖所有对广告内容感兴趣的受众，因此适合中性而温和的推广。</li>',
	'adv_type_text' => '页内文字广告',
	'adv_type_text_tips' => '<li>展现方式: 页内文字广告以表格的形式，显示于首页、主题列表和帖子内容三个页面的中上方，通常使用文字的形式，也可使用小图片和 Flash。当前页面有多个文字广告时，系统会以表格的形式按照设定的显示顺序全部展现，同时能够对表格列数在 3～5 的范围内动态排布，以自动实现最佳的广告排列效果。</li><li>价值分析: 由于此类广告通常以文字形式展现，但其所在的较靠上的页面位置，使得此类广告成为了访问者必读的内容之一。同一页面可以呈现多达十几条文字广告的特性，也决定了它是一种平民化但性价比较高的推广方式，同时还可用于交流版块自身的宣传和公告之用。</li>',
	'adv_type_thread' => '帖内广告',
	'adv_type_thread_tips' => '<li>展现方式: 帖内广告显示于帖子内容的上方、下方或右方，帖子内容的上方和下方通常使用文字的形式，帖子内容右方通常使用图片的形式。当前页面有多个帖内广告时，系统会从中抽取与每页帖数相等的条目进行随机显示。您可以在 全局设置中的其他设置中修改每帖显示的广告数量。</li><li>价值分析: 由于帖子是交流版块最核心的组成部分，嵌入帖子内容内部的帖内广告，便可在用户浏览帖子内容时自然的被接受，加上随机播放的特性，适合于特定内容的有效推广，也可用于交流版块自身的宣传和公告之用。建议设置多条帖内广告以实现广告内容的差异化，从而吸引更多访问者的注意力。</li>',
	...
	'adv_type_intercat_tips' => '<li>展现方式: 分类间广告显示于交流版块首页相邻的两个交流版块分类之间，可使用 468x60 或其他尺寸图片和 Flash 的形式。当前页面有多个分类间广告时，系统会从中抽取与交流版块分类数相等的条目进行随机显示。</li><li>价值分析:由于出现在交流版块首页比较明显的位置，广告展示效果较好，但是过多过大的首页广告可能会招致访问者反感。 </li>',
	'adv_type' => '广告类型',
	'adv_style' => '样式',
	'adv_style_code' => '代码',
	'adv_style_text' => '文字',
	...
	'adv_edit_targets_comment' => '设置本广告投放的页面或交流版块范围',
	'adv_edit_targets_member' => '注册/登录',
	'adv_edit_targets_portal' => '门户',
	'adv_edit_targets_forum' => '交流版块',
	...
	'runwizard_tips' => '<li>快速设置向导将帮助您最快速的设置您的交流版块；</li><li>只有在第四步您确认后，所有的设置才会生效；</li><li>如果您已经运行过本向导或自行配置过交流版块，运行本向导将覆盖您已经设置的相关参数。</li>',
	'runwizard_step_1' => '设置交流版块类型',
	'runwizard_step_2' => '填写交流版块基本信息',
	'runwizard_step_3' => '批量增加版块',
	'runwizard_step_4' => '确认',
	'runwizard_forum_scope' => '交流版块规模',
	...
	'runwizard_security_high' => '严格 (比较严格的权限体系，适用于对会员权限有较高要求的交流版块)',
	'runwizard_security_midding' => '一般 (限制用户的部分操作，适用于绝大部分交流版块)',
	'runwizard_security_low' => '宽松 (开放较多权限给会员，适用于对权限要求不是很严格的交流版块)',
	'runwizard_hobby' => '功能偏好',
	'runwizard_hobby_concision' => '简洁 (关闭娱乐和部分消耗系统资源功能，追求交流版块效率首选)',
	'runwizard_hobby_commonly' => '一般 (按照标准交流版块需求设置，可满足一般交流版块日常需求，效率和功能比较平衡)',
	'runwizard_hobby_abundance' => '丰富 (开启所有站点功能，交流版块会员有较好使用体验，较前两种模式占用服务器资源略高一些)',
	...
	'runwizard_cat' => '分区',
	'runwizard_forum' => '版块',
	'runwizard_forum_initialization' => '以下为您的交流版块初始化信息',
	...
	'cplog_setting_cachethread' => '交流版块页面缓存设置',
	...
	'cplog_icon' => '主题图标',
	'cplog_smilies' => '表情管理',
	'cplog_faq_list' => '交流版块帮助',
	'cplog_faq_detail' => '交流版块帮助',
	...
	'cplog_attach' => '编辑附件',
	'cplog_counter' => '更新交流版块统计',
	'cplog_threads' => '交流版块主题管理',
	'cplog_prune' => '批量删帖',
	'cplog_jswizard' => '数据调用',
	...
	'postsplit_move_tips' => '<li>帖子移动涉及大量的数据转移，请<strong>关闭交流版块</strong>后使用</li><li>为防止数据库在移动过程中出现问题，请先进行数据备份。</li><li>按条件搜索出要移动的主题帖，然后选择目标分表。</li><li>移动操作可能需要一段时间，请耐心等待。</li>',
	...
	'connect_setting_feed_fids' => '允许推送的交流版块',
	'connect_setting_feed_fids_comment' => '设置在哪些交流版块发表的主题可以推送到QQ空间动态，可以按住 CTRL 多选',
	'connect_setting_feed_group' => '圈子是否允许推送',
	'connect_setting_feed_group_comment' => '设置在圈子发表的主题是否可以推送到QQ空间动态',
	'connect_setting_t_allow' => '推送到腾讯微博',
	'connect_setting_t_fids' => '允许推送的交流版块',
	'connect_setting_t_fids_comment' => '设置在哪些交流版块发表的主题可以推送到腾讯微博，可以按住 CTRL 多选',
	'connect_setting_t_group' => '圈子是否允许推送',
	'connect_setting_t_group_comment' => '设置在圈子发表的主题是否可以推送到腾讯微博',
...
# 修改以下语句中的 /discuz 为您的交流版块目录地址，如果程序放在根目录中，请将 /discuz 修改为 /
RewriteBase /discuz
