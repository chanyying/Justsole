...
(
	...
	'cloud_status_error' => '出了点小错，由于站点ID/通信KEY等关键信息丢失导致Discuz!云平台服务出现异常，使用<a href="admin.php?action=cloud&operation=doctor">诊断工具</a>检测站点ID和KEY，如有疑问请访问<a href="http://www.discuz.net/forum-3926-1.html" target="_blank">官方交流版块</a>寻求帮助',
	...
	'cloud_unknown_dns' => '您的站点目前无法连接Discuz!云平台，请检查您服务器网络设置，使用<a href="admin.php?action=cloud&operation=doctor">诊断工具</a>检测DNS解析和接口连通性。<a href="http://cp.discuz.qq.com/faq?fId=1305690058&ADTAG=CP.CLOUD.FAQ.FID" target="_blank">查看帮助</a>，如有疑问请访问<a href="http://www.discuz.net/forum-3926-1.html" target="_blank">官方交流版块</a>求助',
	...
	'cloud_sync_failure' => '站点信息同步失败，原因：<br />{errorMessage} (ERRCODE:{errorCode})<br /><br />如有疑问，请访问<a href="http://www.discuz.net/forum-3926-1.html" target="_blank">官方交流版块</a>寻求帮助',
	...
	'cloud_doctor_setidkey_tips' => '<li style="color:red">修改Discuz!上的站点ID和KEY，可能会导致通信错误、签名错误以及其他的故障，请勿在没有官方人员指导的情况下修改。</li><li style="color:red">修改ID、KEY和状态前，请先备份交流版块的common_setting表。</li>',
	...
	'cloud_application_disable' => '您的站点已被禁止使用此项云服务，如果有疑问请访问<a href="http://www.discuz.net/forum.php?gid=3923" target="_blank">官方交流版块</a>寻求帮助',

	'cloud_search_tips' => '<li>开启漫游搜索功能后，用户可以使用基于漫游的搜索功能。</li>',

	'cloud_stats' => '腾讯分析',
	'cloud_stats_tips' => '<li>选择的样式会显示在交流版块底部的右下方。</li>',
	...
	'cloud_smilies_tips' => '<li>搜尽天下表情，为网站带来无穷的乐趣与体验。</li><li>省略繁琐的上传表情流程，无缝“偷渡”QQ表情到您的网站，交流版块表情变得不再单调无味。</li>',

	'cloud_smilies_status' => '启用SOSO 表情',
	'cloud_storage' => '旋风存储',
	'cloud_storage_tips' => '<li>为网站节省空间带宽，让用户享受超大文件的高速存储，上传下载尽在云端。</li><li>体验高速上传下载，支持单个文件高达2GB的附件上传，附件永久有效，为交流版块降低成本。</li>',
	...
	'connect_setting_feed_fids' => '允许推送的交流版块版块',
	...
	'connect_setting_t_fids' => '允许推送的交流版块版块',
	...
	'security_safe_login_open_comment' => '有效防止恶意注册！选择是，用户必须将交流版块帐号与QQ帐号绑定后，才能在交流版块发帖，回复',
	'security_qq_login_alone_open' => '开启QQ独立登录',
	'security_qq_login_alone_open_comment' => '有效防止盗号！开启后只能使用QQ号登录，即便盗取了交流版块帐号也无法登录发帖',
