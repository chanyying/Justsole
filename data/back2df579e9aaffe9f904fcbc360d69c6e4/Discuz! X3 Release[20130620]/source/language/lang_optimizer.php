...
(
	...
	'optimizer_setting_cache_index' => '缓存交流版块首页',
	...
	'optimizer_setting_sessionclose_desc' => '关闭session机制以后，可明显降低站点的服务器负担，建议在线用户数超过2万时开启本功能<br>注意：游客数和用户的在线时长将不再进行统计，交流版块首页和版块列表页面的在线用户列表功能将不可用',
